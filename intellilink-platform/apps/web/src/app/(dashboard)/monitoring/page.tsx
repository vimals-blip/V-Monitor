  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">Live Telemetry & Metrics Fabric</h1>
          </div>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 px-3 py-1 rounded-lg bg-white dark:bg-[#121824] border border-slate-200 dark:border-[#222E45] text-xs">
      ...
      {host && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="bg-white dark:bg-[#121824] border border-slate-200 dark:border-[#222E45] rounded-xl p-4">
            ...
            <div className="text-xl font-bold text-slate-900 dark:text-white font-mono">{host.cpuCount} vCPUs</div>
          ...
          <div className="bg-white dark:bg-[#121824] border border-slate-200 dark:border-[#222E45] rounded-xl p-4">
            ...
            <div className="w-full bg-slate-100 dark:bg-[#1C263A] h-1.5 rounded-full overflow-hidden mt-1.5">
              <div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white dark:bg-[#121824] border border-slate-200 dark:border-[#222E45] rounded-xl p-5 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <span className="text-[10px] font-mono text-cyan-600 dark:text-cyan-400 bg-cyan-950/80 px-2 py-0.5 rounded border border-cyan-500/40">
                Live Feed
              </span>
            </div>
          </div>
          ...
          <div className="flex items-stretch gap-2">
            ...
            <div className="flex flex-col justify-between items-end text-[9px] font-mono text-slate-500 py-1 pr-1 w-11 shrink-0 select-none">
              ...
              <span className="text-amber-600 dark:text-amber-400/80">60ms</span>
              <span className="text-cyan-600 dark:text-cyan-400/80">30ms</span>
              <span>0ms</span>
            </div>

            {/* Main Visual Canvas */}
            <div className="flex-1 h-52 bg-slate-50 dark:bg-[#0B0F17] rounded-lg border border-slate-200 dark:border-[#222E45] p-3 flex flex-col justify-between relative overflow-hidden">
                  ...
                  wanSamples.map((sample: any, idx: number) => {
                    ...
                    return (
                      <div key={sample.id || idx} className="flex-1 h-full flex flex-col justify-end items-center gap-1 group relative">
                        {/* Hover Tooltip */}
                        <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-1 bg-[#162032] border border-slate-200 dark:border-[#222E45] p-2 rounded-lg text-[10px] font-mono text-slate-900 dark:text-white whitespace-nowrap z-30 pointer-events-none shadow-2xl space-y-0.5">
                          <div className="text-cyan-600 dark:text-cyan-400 font-bold flex items-center justify-between gap-2 border-b border-slate-200 dark:border-[#222E45] pb-1">
                            <span>{sampleTime}</span>
                            <span className={isHigh ? 'text-amber-600 dark:text-amber-400' : 'text-emerald-600 dark:text-emerald-400'}>
                              {latency.toFixed(1)} ms
                            </span>
                          </div>
                          <div className="text-slate-600 dark:text-slate-300">Jitter: ±{jitter.toFixed(1)} ms</div>
                          <div className="text-slate-600 dark:text-slate-300">Packet Loss: {loss}%</div>
                          <div className="text-slate-500 dark:text-slate-400 text-[9px]">Sample #{idx + 1}</div>
                        </div>

                        {/* Bar Track */}
                        <div className="w-full h-32 flex items-end bg-white dark:bg-[#121824]/50 rounded-t overflow-hidden">
                          <div
                        ...
                        {/* Latency Number */}
                        <span className="text-[9px] font-mono text-slate-500 dark:text-slate-400 truncate w-full text-center">
              ...
              <div className="flex items-center justify-between text-[9px] font-mono text-slate-500 pt-1 border-t border-[#1C263A]/80 z-10">
                ...
                <span className="text-cyan-600 dark:text-cyan-400 font-semibold">{wanSamples[wanSamples.length - 1]?.timestamp ? new Date(wanSamples[wanSamples.length - 1].timestamp).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' }) : 'Live'}</span>
              </div>
            </div>
          </div>

          <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 font-mono pt-1 border-t border-[#1C263A]">
            <span>Nominal Latency: 12ms - 28ms</span>
            <span className="text-cyan-600 dark:text-cyan-400">Sub-second BFD resolution</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#121824] border border-slate-200 dark:border-[#222E45] rounded-xl p-5 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <span className="text-[10px] font-mono text-emerald-600 dark:text-emerald-400 bg-emerald-950/60 px-2 py-0.5 rounded border border-emerald-500/30">
                40 Gbps Capacity
              </span>
            </div>
          </div>
          ...
          <div className="flex items-stretch gap-2">
            {/* Y-Axis Column */}
            <div className="flex flex-col justify-between items-end text-[9px] font-mono text-slate-500 py-1 pr-1 w-11 shrink-0 select-none">
              <span className="text-emerald-600 dark:text-emerald-400/80">40G</span>
              <span className="text-slate-500 dark:text-slate-400">30G</span>
              <span className="text-slate-500 dark:text-slate-400">20G</span>
              <span className="text-slate-500 dark:text-slate-400">10G</span>
              <span>0G</span>
            </div>
            ...
            <div className="flex-1 h-52 bg-slate-50 dark:bg-[#0B0F17] rounded-lg border border-slate-200 dark:border-[#222E45] p-3 flex flex-col justify-between relative overflow-hidden">
                  ...
                  popSamples.map((sample: any, idx: number) => {
                    ...
                    return (
                      <div key={sample.id || idx} className="flex-1 h-full flex flex-col justify-end items-center gap-1 group relative">
                        {/* Hover Tooltip */}
                        <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-1 bg-[#162032] border border-slate-200 dark:border-[#222E45] p-2 rounded-lg text-[10px] font-mono text-slate-900 dark:text-white whitespace-nowrap z-30 pointer-events-none shadow-2xl space-y-0.5">
                          <div className="text-emerald-600 dark:text-emerald-400 font-bold flex items-center justify-between gap-2 border-b border-slate-200 dark:border-[#222E45] pb-1">
                            <span>{sampleTime}</span>
                            <span>{gbps} Gbps</span>
                          </div>
                          <div className="text-slate-600 dark:text-slate-300">Capacity: {((parseFloat(gbps) / 40) * 100).toFixed(0)}% of 40G</div>
                          <div className="text-slate-600 dark:text-slate-300">Cluster CPU: {cpu}%</div>
                          <div className="text-slate-500 dark:text-slate-400 text-[9px]">Sample #{idx + 1}</div>
                        </div>
              ...
              <div className="flex items-center justify-between text-[9px] font-mono text-slate-500 pt-1 border-t border-[#1C263A]/80 z-10">
                ...
                <span className="text-emerald-600 dark:text-emerald-400 font-semibold">{popSamples[popSamples.length - 1]?.timestamp ? new Date(popSamples[popSamples.length - 1].timestamp).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' }) : 'Live'}</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 font-mono pt-1 border-t border-[#1C263A]">
            ...
            <span className="text-emerald-600 dark:text-emerald-400">Zero packet drops on fabric</span>
          </div>
        </div>
      </div>

      {/* AIOps Predictive Anomaly Detection Section */}
      <div className="bg-white dark:bg-[#121824] border border-slate-200 dark:border-[#222E45] rounded-xl p-5 space-y-4 text-xs">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-slate-900 dark:text-white text-sm">AIOps Statistical Baseline & Anomaly Engine</h3>
          ...
          <span
            className={`px-2.5 py-1 rounded text-[11px] font-bold border ${
              anomalyData?.status === 'CRITICAL_DEVIATION'
                ...
                ? 'bg-amber-950/60 border-amber-800 text-amber-600 dark:text-amber-400'
                : 'bg-emerald-950/60 border-emerald-800 text-emerald-600 dark:text-emerald-400'
            }`}
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 font-mono">
          <div className="p-3 bg-slate-50 dark:bg-[#0B0F17] rounded-lg border border-slate-200 dark:border-[#222E45]">
            <span className="text-slate-500 dark:text-slate-400 block text-[10px]">ANALYZED METRIC SAMPLES</span>
            <span className="text-slate-900 dark:text-white font-bold text-sm">
              {anomalyData?.totalSamplesAnalyzed || 0} Telemetry Ticks
            </span>
          </div>
          <div className="p-3 bg-slate-50 dark:bg-[#0B0F17] rounded-lg border border-slate-200 dark:border-[#222E45]">
            <span className="text-slate-500 dark:text-slate-400 block text-[10px]">BASELINE MEAN (μ)</span>
            <span className="text-cyan-600 dark:text-cyan-400 font-bold text-sm">
              {anomalyData?.baselineMean || 0} ms
            </span>
          </div>
          <div className="p-3 bg-slate-50 dark:bg-[#0B0F17] rounded-lg border border-slate-200 dark:border-[#222E45]">
            <span className="text-slate-500 dark:text-slate-400 block text-[10px]">STANDARD DEVIATION (σ)</span>
            <span className="text-purple-400 font-bold text-sm">
              ±{anomalyData?.baselineStdDev || 0} ms
            </span>
          </div>
          <div className="p-3 bg-slate-50 dark:bg-[#0B0F17] rounded-lg border border-slate-200 dark:border-[#222E45]">
            <span className="text-slate-500 dark:text-slate-400 block text-[10px]">DETECTED ANOMALIES</span>
              ...
              {anomalyData.anomalies.slice(0, 3).map((anom: any, aIdx: number) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-slate-900 dark:text-white font-bold">{anom.sourceName}</span>
                    <span className="text-slate-500 dark:text-slate-400">{anom.description}</span>
                  </div>
                  <span className="text-amber-600 dark:text-amber-400 font-bold">+{anom.zScore}σ</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-[#121824] border border-slate-200 dark:border-[#222E45] rounded-xl p-5 space-y-3 text-xs">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Cpu className="w-4 h-4 text-cyan-600 dark:text-cyan-400" />
            <h3 className="font-bold text-slate-900 dark:text-white">Live Edge Gateway Appliance Telemetry Stream</h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 font-mono">
          {gwSamples.slice(0, 4).map((sample: any, idx: number) => {
            ...
            return (
              <div key={sample.id || idx} className="p-3 bg-slate-50 dark:bg-[#0B0F17] rounded-lg border border-slate-200 dark:border-[#222E45] space-y-2">
                <div className="flex items-center justify-between text-[11px]">
                  <span className="text-slate-900 dark:text-white font-bold truncate">{sample.sourceId?.slice(0, 12)}...</span>
                  <span className="text-emerald-600 dark:text-emerald-400 text-[10px]">ONLINE</span>
                </div>
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-slate-100 dark:bg-[#1C263A] h-1 rounded-full overflow-hidden">
                    <div
