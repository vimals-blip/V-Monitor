...
export class OrganizationsService {
  ...
  constructor(@InjectRepository(OrganizationEntity) private repo: Repository<OrganizationEntity>) {}
  ...
  async findOne(id: string, user: any) {
    ...
    if (!entity) throw new NotFoundException('Organizations not found');
